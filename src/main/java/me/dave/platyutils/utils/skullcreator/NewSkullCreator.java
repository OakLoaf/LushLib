package me.dave.platyutils.utils.skullcreator;

import com.google.gson.JsonObject;
import com.google.gson.JsonParser;
import me.dave.platyutils.PlatyUtils;
import me.dave.platyutils.utils.SkullCreator;
...
public class NewSkullCreator implements SkullCreator.Interface {
    ...
    private PlayerProfile makeProfile(String b64) {
        ...
        try {
            ...
            if (b64.length() == 0) {
                PlatyUtils.getLogger().warning("Missing base64 texture found - check your config");
            } else {
                PlatyUtils.getLogger().warning("Invalid base64 texture (" + b64 + ") found - check your config");
            }
        }
    ...
    private URL getUrlFromBase64(String base64) throws MalformedURLException {
        ...
        try {
            ...
            PlatyUtils.getLogger().severe(base64 + " does not appear to be a valid texture.");
            return null;
        }
